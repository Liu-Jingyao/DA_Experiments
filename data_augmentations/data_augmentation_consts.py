...
import data_augmentations.offline_augmentations
...
OFFLINE_DATA_AUGMENTATION_DICT: Dict[str, callable] = {names.SYNONYM_REPLACEMENT: data_augmentations.offline_augmentations.batch_synonym_replacement,
                                                       names.RANDOM_DELETION: data_augmentations.offline_augmentations.batch_random_deletion,
